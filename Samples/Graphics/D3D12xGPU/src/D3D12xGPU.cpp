...
void D3D12xGPU::UpdateUI()
{
...

    {
        ...
        for (SIZE_T i = 0; i < m_gpuAdapterDescs.size(); i++)
        {
...
bool D3D12xGPU::RetrieveAdapterIndex(ULONG* adapterIndex, LUID adapterLuid)
{
    for (ULONG i = 0; i < m_gpuAdapterDescs.size(); i++)
    {
